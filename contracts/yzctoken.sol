...
contract YzcIco is MyCryptos{
    address public admin;
    address payable public deposit;
    uint tokenPrice = 0.001 ether; // 1Eth =1000 crpt2; 1crpt2 = 0.001ETH;
    ...
    function invest() payable public returns(bool){
        ...
        require(msg.value >= minInvestment && msg.value <= maxInvestment,"value is not appropirate");
    ...
    function transfer(address to, uint tokens) public override returns(bool success){
        ...
        return super.transfer(to, tokens); //MyCryptos.transfer(to, tokens);
        }

     function transferFrom(address from, address to, uint tokens) public override returns (bool){
         require(block.timestamp > tokenTradeStart);
         MyCryptos.transferFrom(from, to, tokens);
         return true;
         }
